...
xscale(range(1929 1932)) yscale(range(95 170)) xlabels(#4) legend(off) ytitle("Number of Banks in Business") saving("results/banks_fig51", replace)
graph export "results/banks_fig51.png", replace

scatter bib8 bib6 year if year > 1928 & year < 1935, msymbol(circle circle circle) msize(vlarge vlarge vlarge) ///
mcolor(black black black) connect(l l l)  lpat(l l -) lwidth(medium medthick medium) lcolor(black black black) ///
yscale(range(70 180)) legend(off) ytitle("Number of Banks in Business") saving("results/banks_fig52", replace)
graph export "results/banks_fig52.png", replace

scatter bib8 bib6 bibc year if year > 1928 & year < 1935, msymbol(circle circle circle) msize(vlarge vlarge vlarge) ///
mcolor(black black black) connect(l l l)  lpat(l l -) lwidth(medium medthick medium) lcolor(black black black) ///
yscale(range(70 180)) legend(off) ytitle("Number of Banks in Business") saving("results/banks_fig53", replace)
graph export "results/banks_fig53.png", replace
